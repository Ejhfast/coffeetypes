...
tests = [
  ...
  T.match({x:T.number, y:T.number}, {x:23.4,y:67}) is true,
  T.match({x:T.number, y:T.any}, {x:23,y:67}) is true,
  T.match({succeed:T.bool, y:T.number}, {succeed:true,y:67}) is true,
  T.match(T.object.exactly({x:T.number, y:T.number}), {x:23,y:67}) is true,
  ...
  T.match(T.object.exactly({x:T.number}), {x:23,y:67}) is false,
